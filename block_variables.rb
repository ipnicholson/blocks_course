...
# 3. vars declared in surrounding scope are available in block scope, and can be overwritten
# name = "Ian"
...
# 4. vars can be protected in block scope, they won't overwrite vars in surrounding scope
name = "Ian"
